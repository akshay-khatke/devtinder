                        ...
                        <div>
                            ...
                            <ul className="menu p-4 w-full space-y-1">
                                ...
                                <li>
                                    ...
                                    <button onClick={() => navigate("/chatbot")} className="flex items-center gap-3 p-3 rounded-lg hover:bg-base-300 transition-colors">
                                        <BotIcon />
...
const BotIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="size-5"><rect x="3" y="11" width="18" height="10" rx="2"></rect><circle cx="12" cy="5" r="2"></circle><path d="M12 7v4"></path><line x1="8" y1="16" x2="8" y2="16"></line><line x1="16" y1="16" x2="16" y2="16"></line></svg>
);
